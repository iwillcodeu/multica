...
) RETURNING id, workspace_id, title, position, created_at, updated_at, description, icon, status, lead_type, lead_id, priority, start_date, due_date
`
...
SELECT id, workspace_id, title, position, created_at, updated_at, description, icon, status, lead_type, lead_id, priority, start_date, due_date FROM project
